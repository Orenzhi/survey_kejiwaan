                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="widget-tabs-int">
                            <div class="tab-hd">
                                <h2>Detail Kota</h2>
                                <p>Ini merupakan data rinci / detail Kota.</p>
                            </div>
                            ...
                            <div class="widget-tabs-list">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a data-toggle="tab" href="#menu1">Grafik Kota</a></li>
                                </ul>
		...
		<th>Action</th>
			...
			<td style="text-align:center"><div class="btn-group" role="group" aria-label="...">
				<?php 
				echo anchor(site_url('kota/read/'.$kota->id_kota),' ','class="btn btn-success btn-sm fa fa-eye"'); 
				echo anchor(site_url('kota/update/'.$kota->id_kota),' ','class="btn btn-warning btn-sm fa fa-pencil"'); 
				echo anchor(site_url('kota/delete/'.$kota->id_kota),' ','onclick="javasciprt: return confirm(\'Anda Yakin Akan Menghapus Data ini ?\')" class="btn btn-sm btn-danger fa fa-trash"'); 
				?></div>
			</td>
		</tr>
                                                        <?php
