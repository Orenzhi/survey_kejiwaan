                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="widget-tabs-int">
                            <div class="tab-hd">
                                ...
                                <p>Ini merupakan data rinci / detail Kecamatan.</p>
                            </div>
                            ...
                            <div class="widget-tabs-list">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a data-toggle="tab" href="#menu1">Grafik Kecamatan</a></li>
                                </ul>
		...
		<th>Action</th>
			...
			<td style="text-align:center"><div class="btn-group" role="group" aria-label="...">
				<?php 
				echo anchor(site_url('kecamatan/read/'.$kecamatan->id_kecamatan),' ','class="btn btn-success btn-sm fa fa-eye"'); 
				echo anchor(site_url('kecamatan/update/'.$kecamatan->id_kecamatan),' ','class="btn btn-warning btn-sm fa fa-pencil"'); 
				echo anchor(site_url('kecamatan/delete/'.$kecamatan->id_kecamatan),' ','onclick="javasciprt: return confirm(\'Anda Yakin Akan Menghapus Data ini ?\')" class="btn btn-sm btn-danger fa fa-trash"'); 
				?></div>
			</td>
		</tr>
                                                        <?php
