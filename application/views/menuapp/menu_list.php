...
<html>
    ...
    <body-->
		...
		<th>Action</th>
                                                    ...
                                                    foreach ($menuapp_data as $menuapp)
                                                    {
                                                        ?>
                                                        <tr>
			<td><?php echo ++$start ?></td>
			<td><?php echo $menuapp->menu ?></td>
			<td><?php echo $menuapp->icon ?></td>
			<td style="text-align:center"><div class="btn-group" role="group" aria-label="...">
				<?php 
				echo anchor(site_url('menuapp/read/'.$menuapp->kode_menu),' ','class="btn btn-success btn-sm fa fa-eye"'); 
				echo anchor(site_url('menuapp/update/'.$menuapp->kode_menu),' ','class="btn btn-warning btn-sm fa fa-pencil"'); 
				echo anchor(site_url('menuapp/delete/'.$menuapp->kode_menu),' ','onclick="javasciprt: return confirm(\'Anda Yakin Akan Menghapus Data ini ?\')" class="btn btn-sm btn-danger fa fa-trash"'); 
				?></div>
			</td>
		</tr>
                                                        <?php
