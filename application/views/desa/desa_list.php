                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="widget-tabs-int">
                            <div class="tab-hd">
                                <h2>Detail Desa</h2>
                                <p>Ini merupakan data rinci / detail Desa.</p>
                            </div>
                            ...
                            <div class="widget-tabs-list">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a data-toggle="tab" href="#menu1">Grafik Desa</a></li>
                                </ul>
		...
		<th>Action</th>
			...
			<td><?php echo $desa->id_kecamatan_fk ?></td>
			...
			<td style="text-align:center"><div class="btn-group" role="group" aria-label="...">
				<?php 
				echo anchor(site_url('desa/read/'.$desa->id_desa),' ','class="btn btn-success btn-sm fa fa-eye"'); 
				echo anchor(site_url('desa/update/'.$desa->id_desa),' ','class="btn btn-warning btn-sm fa fa-pencil"'); 
				echo anchor(site_url('desa/delete/'.$desa->id_desa),' ','onclick="javasciprt: return confirm(\'Anda Yakin Akan Menghapus Data ini ?\')" class="btn btn-sm btn-danger fa fa-trash"'); 
				?></div>
			</td>
		</tr>
                                                        <?php
