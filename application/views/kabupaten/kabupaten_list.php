...
<html>
    ...
    <body-->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="widget-tabs-int">
                            <div class="tab-hd">
                                ...
                                <p>Ini merupakan data rinci / detail Kabupaten.</p>
                            </div>
                            <div class="box pull-right">
                                <?php echo anchor(site_url('kabupaten/create'),'Tambah Data', 'class="btn btn-primary fa fa-plus btn-sm"'); ?>
                            </div>
                            <div class="widget-tabs-list">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#home">List Kabupaten</a></li>
                                    <li><a data-toggle="tab" href="#menu1">Grafik Kabupaten</a></li>
                                </ul>
		...
		<th>Action</th>
			...
			<td><?php echo $kabupaten->kode_prov ?></td>
			<td><?php echo $kabupaten->nama ?></td>
			<td style="text-align:center"><div class="btn-group" role="group" aria-label="...">
				<?php 
				echo anchor(site_url('kabupaten/read/'.$kabupaten->kode_kab),' ','class="btn btn-success btn-sm fa fa-eye"'); 
				echo anchor(site_url('kabupaten/update/'.$kabupaten->kode_kab),' ','class="btn btn-warning btn-sm fa fa-pencil"'); 
				echo anchor(site_url('kabupaten/delete/'.$kabupaten->kode_kab),' ','onclick="javasciprt: return confirm(\'Anda Yakin Akan Menghapus Data ini ?\')" class="btn btn-sm btn-danger fa fa-trash"'); 
				?></div>
			</td>
		</tr>
                                                        <?php
		...
		<?php echo anchor(site_url('kabupaten/word'), 'Word', 'class="btn btn-primary"'); ?>
	    <!--/div>
