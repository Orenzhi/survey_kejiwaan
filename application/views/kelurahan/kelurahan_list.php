...
<html>
    ...
    <body-->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="widget-tabs-int">
                            <div class="tab-hd">
                                ...
                                <p>Ini merupakan data rinci / detail Kelurahan.</p>
                            </div>
                            ...
                            <div class="widget-tabs-list">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a data-toggle="tab" href="#menu1">Grafik Kelurahan</a></li>
                                </ul>
		...
		<th>Action</th>
			...
			<td><?php echo $kelurahan->kode_kec ?></td>
			<td><?php echo $kelurahan->nama ?></td>
			<td style="text-align:center"><div class="btn-group" role="group" aria-label="...">
				<?php 
				echo anchor(site_url('kelurahan/read/'.$kelurahan->kode_kel),' ','class="btn btn-success btn-sm fa fa-eye"'); 
				echo anchor(site_url('kelurahan/update/'.$kelurahan->kode_kel),' ','class="btn btn-warning btn-sm fa fa-pencil"'); 
				echo anchor(site_url('kelurahan/delete/'.$kelurahan->kode_kel),' ','onclick="javasciprt: return confirm(\'Anda Yakin Akan Menghapus Data ini ?\')" class="btn btn-sm btn-danger fa fa-trash"'); 
				?></div>
			</td>
		</tr>
                                                        <?php
		...
		<?php echo anchor(site_url('kelurahan/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('kelurahan/word'), 'Word', 'class="btn btn-primary"'); ?>
	    <!--/div>
